...
|------|-----|
| Structure | HTML5 |
| Styling | CSS3 — custom dark/light mode, scroll animations, responsive grid |
...
```bash
git clone https://github.com/mahesh001-sys/portfolio.git
cd portfolio
```

Then open `index.html` in your browser — or use the **Live Server** extension in VS Code for live preview.

---

## Live Site

**[mahesh001-sys.github.io/portfolio](https://mahesh001-sys.github.io/portfolio)**
...
| Platform | Link |
|----------|------|
| Email | maheshbanoth057@gmail.com |
| Phone | +91 6305296075 |
| LinkedIn | [linkedin.com/in/banoth-mahesh-kumar](https://linkedin.com/in/banoth-mahesh-kumar) |
| GitHub | [github.com/mahesh001-sys](https://github.com/mahesh001-sys) |

---

*Built and maintained by Banoth Mahesh Kumar*
